    ...
    with open('data_base.csv', 'r') as resultFile:                                  # прочесть файл базы данных с ID
        ...
        for row in reader:
            try:
                ...
                pass
                continue                                                    # в случае если база данных пуста                                                                        # вернуть пустое множество
...
if __name__ == "__main__":
    ...
    while True:
        ...
        try:
            ...
            print(Fore.RED + 'Возможно у Вас включена двухфакторная аутентификация. Для работы программы ее необходимо отключить')
            print(Fore.YELLOW + 'Попрбоуйте снова')
